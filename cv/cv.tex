...
Prefered: C++(proficient), JavaScript(proficient), Java(proficient), PHP(proficient), Python(prior experience), Ruby(prior experience). \\
Other: C, CSS, HTML, LaTeX, Emacs Lisp. \\
\item[] {\sl Other experience} \\
Linux, Git, Emacs, Apache, Nginx, jQuery, Angular, Laravel, Rails, Django, Agile Development, Drupal, React, Spring, Webpack, Docker, Amazon Web Services.
\end{itemize}
...
%% \item[] {\sl 2015 to present}, Organizer of ACM-ICPC contest in L  \\
\end{itemize}
